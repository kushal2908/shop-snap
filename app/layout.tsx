...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Stop uploading blurry photos. Get high-definition, watermarked images optimized for the Facebook algorithm.",
    url: "https://shopsnap.xyz",
    siteName: "shopSnap Bangladesh",
    images: [{ url: "/logo.png", width: 1200, height: 630, alt: "shopSnap Dashboard" }],
    locale: "en_BD",
    type: "website",
  },
  twitter: {
  ...
  verification: {
    google: "aGoIlTqdHwfXDb0fopChUX8J5fOlF2SBh0mbG4XdPYs",
  },
